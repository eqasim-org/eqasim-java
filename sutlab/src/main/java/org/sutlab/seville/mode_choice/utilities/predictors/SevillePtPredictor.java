...
public class SevillePtPredictor extends CachedVariablePredictor<SevillePtVariables> {

	private final TransitSchedule schedule;

	@Inject
	public SevillePtPredictor(TransitSchedule schedule) {
	...
	@Override
	public SevillePtVariables predict(Person person, DiscreteModeChoiceTrip trip, List<? extends PlanElement> elements) {
		...
		return new SevillePtVariables(inVehicleTime_min, waitingTime_min, accessEgressTime_min, numberOfLineSwitches,
