...
public class AlphaClusterCalibrator implements FastCalibration {
    ...
    private final HannoverModeParameters modeParameters;
            ...
            if ((Boolean) plan.getAttributes().getAttribute("createdLastIteration")) {
                ...
                for (DiscreteModeChoiceTrip trip : trips) {
                    ...
                    if (consideredModes.contains(mode) && !sameLocation) {
                        ...
                        int cluster = HannoverPredictorUtils.getCluster(person);
    ...
    private void setAlphas(int cluster, Map<String, Double> alphas){
        ...
        switch (cluster) {
            ...
            default:
                ...
                alphasRegion0Changes.put("car_passenger", alphas.get("car_passenger") - modeParameters.carPassenger.alpha_u);
                ...
                modeParameters.carPassenger.alpha_u   = alphas.get("car_passenger");
                break;
        }
    }
