...
public class HannoverCarUtilityEstimator extends CarUtilityEstimator {
	private final HannoverModeParameters parameters;
	private final CarPredictor predictor;

	@Inject
	public HannoverCarUtilityEstimator(HannoverModeParameters parameters, CarPredictor predictor) {
