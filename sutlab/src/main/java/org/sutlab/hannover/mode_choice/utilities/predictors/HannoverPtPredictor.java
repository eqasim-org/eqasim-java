...
public class HannoverPtPredictor extends CachedVariablePredictor<HannoverPtVariables> {
	static public final String HANNOVER_ATTRIBUTE = "isHannover";

	private final TransitSchedule schedule;

	@Inject
	public HannoverPtPredictor(TransitSchedule schedule) {
	...
	@Override
	public HannoverPtVariables predict(Person person, DiscreteModeChoiceTrip trip, List<? extends PlanElement> elements) {
