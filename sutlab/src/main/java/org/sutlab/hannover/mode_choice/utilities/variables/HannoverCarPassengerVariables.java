...
public class HannoverCarPassengerVariables implements BaseVariables {
    final public double travelTime_min;
	final public double euclideanDistance_km;
	final public double accessEgressTime_min;

    public HannoverCarPassengerVariables(double travelTime_min, double euclideanDistance_km, double accessEgressTime_min) {
