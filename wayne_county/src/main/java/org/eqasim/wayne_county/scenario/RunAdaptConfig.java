package org.eqasim.wayne_county.scenario;
...
public class RunAdaptConfig {
	...
	static public void adaptConfiguration(Config config) {
		...
		eqasimConfig.setCostModel(TransportMode.car, WayneCountyModeChoiceModule.CAR_COST_MODEL_NAME);
		eqasimConfig.setCostModel(TransportMode.pt, WayneCountyModeChoiceModule.PT_COST_MODEL_NAME);

		DiscreteModeChoiceConfigGroup dmcConfig = (DiscreteModeChoiceConfigGroup) config.getModules()
				.get(DiscreteModeChoiceConfigGroup.GROUP_NAME);

		dmcConfig.setModeAvailability(WayneCountyModeChoiceModule.MODE_AVAILABILITY_NAME);
	}
}
