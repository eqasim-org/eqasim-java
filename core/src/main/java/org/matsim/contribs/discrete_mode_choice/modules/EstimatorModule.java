...
public class EstimatorModule extends AbstractDiscreteModeChoiceExtension {
    ...
    public CumulativeTourEstimator provideCumulativeTourEstimator(TripEstimator tripEstimator,
                                                                  TimeInterpretation timeInterpretation,
                                                                  TripConstraintFactory tripConstraintFactory, ModeAvailability modeAvailability) {
        return new CumulativeTourEstimator(tripEstimator, timeInterpretation, tripConstraintFactory, modeAvailability);
    }
}
