...
public interface TourEstimator {
    ...
    default TourCandidate estimateTour(Person person, List<String> modes, List<DiscreteModeChoiceTrip> trips, List<TourCandidate> previousTours, boolean validate) {
        return estimateTour(person, modes, trips, previousTours);
    }
}
