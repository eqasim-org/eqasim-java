...
public class VolumesAnalyzer implements LinkLeaveEventHandler, VehicleEntersTrafficEventHandler {
    ...
    public VolumesAnalyzer(final int timeBinSize, final int maxTime, final Network network, Scenario scenario) {
        this(timeBinSize, maxTime, network, false, scenario);
    }
    ...
    public boolean getObserveModes() {
        return observeModes;
    }
