...
public final class NetworkRoutingInclAccessEgressModule implements RoutingModule {
    ...
    public synchronized List<? extends PlanElement> calcRoute(RoutingRequest request) {
        ...
        Link accessActLink = multimodalLinkChooser.decideAccessLink(request, filteredNetwork, this.mode);
        Link egressActLink = multimodalLinkChooser.decideEgressLink(request, filteredNetwork, this.mode);
