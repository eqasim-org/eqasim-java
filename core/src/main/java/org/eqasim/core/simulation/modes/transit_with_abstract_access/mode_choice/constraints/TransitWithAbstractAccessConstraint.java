package org.eqasim.core.simulation.modes.transit_with_abstract_access.mode_choice.constraints;
...
public class TransitWithAbstractAccessConstraint implements TripConstraint {

    public static final String NAME = "AbstractAccessConstraint";


    private final String transitWithAbstractAccessModeName;

    public TransitWithAbstractAccessConstraint(String transitWithAbstractAccessModeName) {
    ...
    static public class Factory implements TripConstraintFactory {
        ...
        public Factory(Config config) {
            ConfigGroup configGroup = config.getModules().get(TransitWithAbstractAbstractAccessModuleConfigGroup.GROUP_NAME);
            if(configGroup == null) {
                throw new IllegalStateException("AbstractAccessConstraint cannot be used if the " + TransitWithAbstractAbstractAccessModuleConfigGroup.GROUP_NAME + " module is not specified in the config");
            }
            this.transitWithAbstractAccessModeName = ((TransitWithAbstractAbstractAccessModuleConfigGroup) configGroup).getModeName();
        }

        @Override
        public TripConstraint createConstraint(Person person, List<DiscreteModeChoiceTrip> planTrips,
                                               Collection<String> availableModes) {
            return new TransitWithAbstractAccessConstraint(transitWithAbstractAccessModeName);
        }
    }
}
