...
public class AbstractAccessLegItem {
    ...
    public boolean toTransitStopFacility;

    public AbstractAccessLegItem(Id<Person> personId, int personTripId, int legIndex, Id<AbstractAccessItem> abstractAccessItemId, Id<TransitStopFacility> transitStopFacilityId, boolean toTransitStopFacility) {
        ...
        this.toTransitStopFacility = toTransitStopFacility;
    }
}
