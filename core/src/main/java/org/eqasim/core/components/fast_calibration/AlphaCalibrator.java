...
public class AlphaCalibrator implements FastCalibration {
    ...
    private Map<String, Double> getAlphas() {
		...
		alphas.put("car_passenger", modeParameters.carPassenger.alpha_u);
		return alphas;
    }

    private void setAlphas(Map<String, Double> alphas) {
        modeParameters.car.alpha_u = alphas.getOrDefault("car", modeParameters.car.alpha_u);
		modeParameters.pt.alpha_u = alphas.getOrDefault("pt", modeParameters.pt.alpha_u);
		modeParameters.walk.alpha_u = alphas.getOrDefault("walk", modeParameters.walk.alpha_u);
		modeParameters.bike.alpha_u = alphas.getOrDefault("bike", modeParameters.bike.alpha_u);
		modeParameters.carPassenger.alpha_u = alphas.getOrDefault("car_passenger", modeParameters.carPassenger.alpha_u);
    }
    ...
    private void saveParametersToYaml(int iteration) throws IOException {
        ...
        saveToYamlFile(outputFile);
    }

    protected Object[][] getParameterObjects() {
		return new Object[][] {
				{modeParameters.car, "car"},
				{modeParameters.pt, "pt"},
				{modeParameters.bike, "bike"},
				{modeParameters.walk, "walk"},
				{modeParameters.drt, "drt"},
				{modeParameters.carPassenger, "car_passenger"}
		};
	}
