...
public class GenerateCustomConfig {
	protected List<String> activity_types = Arrays.asList("home", "work", "education", "shop", "leisure", "other",
	...
	public GenerateCustomConfig(CommandLine cmd, String prefix, double sampleSize, int randomSeed, int threads) {
	...
	public GenerateCustomConfig(CommandLine cmd, String prefix, double sampleSize, int randomSeed, int threads, List<String> custom_activities) {
		this.sampleSize = sampleSize;
		this.prefix = prefix;
		this.cmd = cmd;
		this.randomSeed = randomSeed;
		this.threads = threads;
		this.activity_types = custom_activities;
	}
