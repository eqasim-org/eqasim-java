 ...
 * @author mrieser
 */
public final class JakartaMcRoadPricingReaderXMLv1 extends MatsimXmlParser  {
	...
	private JakartaMcRoadPricingSchemeImpl scheme = null;

	private Id<Link> currentLinkId = null;

	private boolean hasLinkCosts = false;

	public JakartaMcRoadPricingReaderXMLv1(JakartaMcRoadPricingSchemeImpl scheme){
		this.scheme = scheme;
	}
