...
import org.eqasim.examples.corsica_drt.sharingPt.PTStationFinder2;
...
public class GeneralizedStationBasedConstraint2 extends AbstractTripConstraint {
    ...
    @Inject
    public GeneralizedStationBasedConstraint2(PTStationFinder2 stationFinder, Scenario scenario, String name, InteractionFinder interactionFinder) {
    ...
    public static class Factory implements TripConstraintFactory {
        ...
        public Factory(PTStationFinder2 stationFinder, Scenario scenario, String name, InteractionFinder interactionFinder) {
            this.stationFinder = stationFinder;
            this.scenario = scenario;
            this.name=name;
            this.interactionFinder = interactionFinder;
        ...
        public TripConstraint createConstraint(Person person, List<DiscreteModeChoiceTrip> planTrips,
            ...
            return new GeneralizedStationBasedConstraint2(stationFinder,scenario,name,interactionFinder);
        }
    }
