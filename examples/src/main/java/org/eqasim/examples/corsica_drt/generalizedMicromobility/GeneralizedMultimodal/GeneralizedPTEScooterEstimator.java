...
public class GeneralizedPTEScooterEstimator implements UtilityEstimator {
    ...
    public GeneralizedPTEScooterEstimator(SharingPTParameters parameters, GeneralizedPTBikeSharePredictor sharingPTPredictor, String mode) {
