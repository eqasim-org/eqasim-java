...
public class GeneralizedBikeSharePTEstimator implements UtilityEstimator {

    private final SharingPTParameters parameters;
    private final GeneralizedBikeSharePTPredictor sharingPTPredictor;
    private final String name;



    public GeneralizedBikeSharePTEstimator(SharingPTParameters parameters, GeneralizedBikeSharePTPredictor sharingPTPredictor, String mode) {
