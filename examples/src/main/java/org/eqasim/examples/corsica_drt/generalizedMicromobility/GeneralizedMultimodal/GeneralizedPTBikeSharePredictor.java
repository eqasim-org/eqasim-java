...
public class GeneralizedPTBikeSharePredictor extends CachedVariablePredictor<SharingPTVariables> {
    ...
    public GeneralizedPTBikeSharePredictor(GeneralizedMultimodalCostModel multimodalCostModel, GeneralizedCostParameters parameters, String name, String underlyingMode) {
