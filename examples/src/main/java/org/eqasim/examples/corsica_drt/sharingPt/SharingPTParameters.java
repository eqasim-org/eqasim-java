...
public class SharingPTParameters extends ModeParameters {
    ...
    public class SharingPTMixParameters{
        // Parameters for PT
        public double alpha_u = 0.0;
        public double betaTravelTime_u_min = 0.0;
        ...
        //Parameters for SharingPart
        public double alpha_uAcc = 0.0;
        public double betaTravelTime_u_minAcc = 0.0;

        public double betaAccess_TimeAcc = 0.0;
        public double betaEgress_TimeAcc=0.0;
        //public double betaDetour_Time=0.0;
        public double betaParkingTime_u_minAcc = 0.0;

        public double betaFreeFloatingAcc=0.0;
        public double betaHybridAcc=0.0;
        public double betaPedelecAcc=0.0;
        public double betaBatteryAcc=0.0;
        public double betaAvailabilityAcc=0.0;
        public double betaAgeAcc=0.0;
        public double betaBikeAccAcc=0.0;
        public double betaCarAccAcc=0.0;
        public double betaPTPassAcc=0.0;
        public double betaMaasSuscriptionAcc=0.0;
        public double lambdaAcc=0.0;
        public double poolAcc=0.0;
        public double personConstantAcc=0.0;
    }
    public class PTSharingMixParameters{
        // Parameters for PT
        public double alpha_u = 0.0;
        public double betaTravelTime_u_min = 0.0;
    ...
    public static SharingPTParameters buildDefault() {
        ...
        // PT+ Sharing bike
        parameters.combinedSharingPT.betaTravelTime_u_min = -0.065;
        parameters.combinedSharingPT.betaAccess_Time=-0.040;
        parameters.combinedSharingPT.betaEgress_Time=-0.03;
        parameters.combinedSharingPT.betaCrowding=-0.001;
        parameters.combinedSharingPT.betaTransfers=-0.298;
        parameters.combinedSharingPT.personConstant=-1.205;
        parameters.combinedSharingPT.betaAge=0.013;
        parameters.combinedSharingPT.betaBikeAcc=0.9;
        parameters.combinedSharingPT.betaCarAcc=-1.556;
        parameters.combinedSharingPT.betaPTPass=3.651;
        parameters.combinedSharingPT.betaMaasSuscription=1.241;
        parameters.combinedSharingPT.lambda=1.792;


        parameters.combinedSharingPT.betaTravelTime_u_minAcc= -0.09;
        parameters.combinedSharingPT.betaAccess_TimeAcc=-0.040;
        parameters.combinedSharingPT.betaEgress_TimeAcc=-0.03;
        parameters.combinedSharingPT.betaParkingTime_u_minAcc=-0.040;
        parameters.combinedSharingPT.betaAvailabilityAcc=0.006;
        parameters.combinedSharingPT.betaFreeFloatingAcc=0.418;
        parameters.combinedSharingPT.betaPedelecAcc=-0.321;
        parameters.combinedSharingPT.betaBatteryAcc=0.006;
        parameters.combinedSharingPT.personConstantAcc=-1.199;
        parameters.combinedSharingPT.betaAgeAcc=-0.041;
        parameters.combinedSharingPT.betaBikeAccAcc=2.345;
        parameters.combinedSharingPT.betaCarAccAcc=-1.026;
        parameters.combinedSharingPT.betaPTPassAcc=1.799;
        parameters.combinedSharingPT.betaMaasSuscriptionAcc=1.172;
        parameters.combinedSharingPT.lambdaAcc=1.587;


        // PT + SHaring as egress Mode
