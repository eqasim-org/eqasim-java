...
import org.eqasim.examples.corsica_drt.mode_choice.predictors.KraussPTPredictor;
...
import org.eqasim.examples.corsica_drt.mode_choice.variables.KraussPTVariables;
...
public class KraussPTEstimator implements UtilityEstimator {
    ...
    @Inject
    public KraussPTEstimator(SharingPTParameters parameters, KraussPTPredictor predictor, KraussPersonPredictor personPredictor) {
