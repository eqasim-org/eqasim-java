...
public class SharingPTSharingPredictor extends CachedVariablePredictor<SharingPTVariables> {
    @Inject
    public SharingPTSharingPredictor(@Named("sharing:bikeShare")RoutingModule accessRoutingMode, @Named("pt")RoutingModule ptRoutingModule,
