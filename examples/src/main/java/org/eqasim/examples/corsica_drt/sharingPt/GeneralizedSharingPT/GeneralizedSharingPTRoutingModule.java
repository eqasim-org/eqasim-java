...
public class GeneralizedSharingPTRoutingModule implements RoutingModule {
    ...
    public GeneralizedSharingPTRoutingModule(RoutingModule sharingRoutingModule, RoutingModule ptRoutingModule, Network network, Map<Id<TransitStopFacility>,TransitStopFacility> ptStops){
