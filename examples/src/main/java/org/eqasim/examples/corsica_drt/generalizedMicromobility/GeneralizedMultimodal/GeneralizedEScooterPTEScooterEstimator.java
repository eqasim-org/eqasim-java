...
public class GeneralizedEScooterPTEScooterEstimator implements UtilityEstimator {
    ...
    public GeneralizedEScooterPTEScooterEstimator(SharingPTParameters parameters, GeneralizedBikeSharingPTBikeSharingPredictor sharingPTPredictor, String mode) {
