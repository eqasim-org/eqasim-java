...
public class GeneralizedEScooterPTEScooterPredictor extends CachedVariablePredictor<SharingPTVariables> {
    ...
    public GeneralizedEScooterPTEScooterPredictor(GeneralizedMultimodalCostModel multimodalCostModel, GeneralizedCostParameters parameters, String name, String underlyingMode) {
