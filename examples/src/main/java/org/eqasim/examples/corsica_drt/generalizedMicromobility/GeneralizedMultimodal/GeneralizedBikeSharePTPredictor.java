...
public class GeneralizedBikeSharePTPredictor extends CachedVariablePredictor<SharingPTVariables> {
    ...
    public GeneralizedBikeSharePTPredictor(GeneralizedMultimodalCostModel multimodalCostModel, GeneralizedCostParameters parameters, String name, String underlyingMode) {
