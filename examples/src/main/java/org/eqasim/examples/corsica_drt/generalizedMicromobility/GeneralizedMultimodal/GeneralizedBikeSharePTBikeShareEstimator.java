...
public class GeneralizedBikeSharePTBikeShareEstimator implements UtilityEstimator {

    private final SharingPTParameters parameters;
    private final GeneralizedBikeSharingPTBikeSharingPredictor sharingPTPredictor;
    private final String name;



    public GeneralizedBikeSharePTBikeShareEstimator(SharingPTParameters parameters, GeneralizedBikeSharingPTBikeSharingPredictor sharingPTPredictor, String mode) {
