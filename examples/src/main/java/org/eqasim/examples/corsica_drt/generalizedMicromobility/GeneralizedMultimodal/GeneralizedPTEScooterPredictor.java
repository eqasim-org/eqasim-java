...
public class GeneralizedPTEScooterPredictor extends CachedVariablePredictor<SharingPTVariables> {
    ...
    public GeneralizedPTEScooterPredictor(GeneralizedMultimodalCostModel multimodalCostModel, GeneralizedCostParameters parameters, String name, String underlyingMode) {
