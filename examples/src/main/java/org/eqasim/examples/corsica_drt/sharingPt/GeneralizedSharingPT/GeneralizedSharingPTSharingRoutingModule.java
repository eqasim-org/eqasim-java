...
public class GeneralizedSharingPTSharingRoutingModule implements RoutingModule {
    ...
    public GeneralizedSharingPTSharingRoutingModule(RoutingModule sharingRoutingModule, RoutingModule ptRoutingModule, Network network, Map<Id<TransitStopFacility>,TransitStopFacility> ptStops){
