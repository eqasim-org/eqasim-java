...
public class GeneralizedCostParameters implements ParameterDefinition {
    ...
    public static void applyCommandLineMicromobility(String prefix, CommandLine cmd, ParameterDefinition parameterDefinition) throws Exception {
        ...
        validateSharingCostParameters((GeneralizedCostParameters) parameterDefinition);
    ...
    public static void applyMapMicromobilityCosts(GeneralizedCostParameters parameterDefinition, Map<String, String> values) {
        for (Map.Entry<String, String> entry : values.entrySet()) {
            String option = entry.getKey();
            String value = entry.getValue();
