...
public class GeneralizedEScooterPTEstimator implements UtilityEstimator {
    ...
    public GeneralizedEScooterPTEstimator(SharingPTParameters parameters, GeneralizedBikeSharePTPredictor sharingPTPredictor, String mode) {
