...
public class GeneralizedEScooterPTPredictor extends CachedVariablePredictor<SharingPTVariables> {
    ...
    public GeneralizedEScooterPTPredictor(GeneralizedMultimodalCostModel multimodalCostModel, GeneralizedCostParameters parameters, String name, String underlyingMode) {
