...
public class GeneralizedBikeSharingPTBikeSharingPredictor extends CachedVariablePredictor<SharingPTVariables> {

    private final GeneralizedMultimodalCostModel multimodalCostModel;

    private final GeneralizedCostParameters parameters;
    private final String mode;
    private final String underlyingMode;

    public GeneralizedBikeSharingPTBikeSharingPredictor(GeneralizedMultimodalCostModel multimodalCostModel, GeneralizedCostParameters parameters, String name, String underlyingMode) {
