...
import org.eqasim.examples.corsica_drt.mode_choice.predictors.KraussEScooterPredictor;
...
public class KraussEScooterEstimator implements UtilityEstimator {
	...
	@Inject
	public KraussEScooterEstimator(SharingPTParameters parameters, KraussEScooterPredictor predictor, KraussPersonPredictor personPredictor) {
