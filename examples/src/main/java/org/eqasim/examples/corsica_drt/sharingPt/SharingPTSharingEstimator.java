...
public class SharingPTSharingEstimator implements UtilityEstimator {
    ...
    private final SharingPTSharingPredictor sharingPTPredictor;
    @Inject
    public SharingPTSharingEstimator(SharingPTParameters parameters, SharingPTSharingPredictor sharingPTPredictor) {
