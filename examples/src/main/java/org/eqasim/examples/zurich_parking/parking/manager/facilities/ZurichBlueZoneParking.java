...
public class ZurichBlueZoneParking extends ActivityFacilityImpl implements ParkingFacility {
    ...
    public ZurichBlueZoneParking(Id<ActivityFacility> id, Coord coordParking, Id<Link> linkId, double capacity, double maxParkingDuration) {
