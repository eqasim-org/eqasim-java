...
import org.eqasim.examples.zurich_carsharing.mode_choice.utilities.estimators.CarsharingEstimator;
...
public class CarsharingModeChoiceModule extends AbstractEqasimExtension {
	...
	static public final String CARSHARING_ESTIMATOR_NAME = "CarsharingEstimator";
	...
	public CarsharingModeChoiceModule(CommandLine commandLine) {
