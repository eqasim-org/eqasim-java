package org.eqasim.examples.SMMFramework.testScenarios.preparationScenarios;
...
public class HomeLocationsToESRI {
    ...
    public HomeLocationsToESRI(final Population population, final Network network, final CoordinateReferenceSystem crs, final String outputDir) {
...
//                writeActs();
    ...
    private void writeHomeLocations() throws IOException {
