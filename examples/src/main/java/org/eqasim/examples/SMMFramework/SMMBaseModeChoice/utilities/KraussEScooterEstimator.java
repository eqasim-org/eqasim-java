...
import org.eqasim.examples.SMMFramework.SMMBaseModeChoice.predictors.KraussEScooterPredictor;
...
public class KraussEScooterEstimator implements UtilityEstimator {
	...
	@Inject
	public KraussEScooterEstimator(SMMParameters parameters, KraussEScooterPredictor predictor, KraussPersonPredictor personPredictor) {
