...
public class KraussCarVariables implements BaseVariables {
    ...
    public KraussCarVariables(double travelTime_u_min, double access_Time, double egress_Time, double parkingTime_u_min, double cost) {
