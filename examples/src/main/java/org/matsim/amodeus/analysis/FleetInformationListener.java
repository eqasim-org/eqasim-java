...
public class FleetInformationListener
		implements BeforeMobsimListener, AfterMobsimListener, ActivityStartEventHandler, PersonDepartureEventHandler,
	...
	public void notifyBeforeMobsim(BeforeMobsimEvent event) {
		// We do it like that, because in some cases (no prediction of prices) the
		// FleetDistanceListener is not even requested via injection. In such cases, it
		// will not
		// capture events.
