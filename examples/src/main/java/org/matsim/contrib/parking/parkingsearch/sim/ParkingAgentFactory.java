...
public class ParkingAgentFactory implements AgentFactory {
	...
	public MobsimAgent createMobsimAgentFromPerson(Person p) {
		...
		ParkingAgentLogic agentLogic = new ParkingAgentLogic(p.getSelectedPlan(), parkingManager, walkRouter, network,
					parkingRouter, events, ((QSim) qsim).getSimTimer(),teleportationLogic, psConfigGroup);;
