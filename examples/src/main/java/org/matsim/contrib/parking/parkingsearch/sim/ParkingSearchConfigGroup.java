...
public class ParkingSearchConfigGroup extends ReflectiveConfigGroup {
    ...
    private static final String PARKINGSEARCHTIMELIMIT = "parkingSearchTimeLimit";
    private double parkingSearchTimeLimit = 6 * 3600.0;
    ...
    @StringGetter(PARKINGSEARCHTIMELIMIT)
    public double getParkingSearchTimeLimit() {
        return parkingSearchTimeLimit;
    }
    ...
    @StringSetter(PARKINGSEARCHTIMELIMIT)
    public void setParkingSearchTimeLimit(double parkingSearchTimeLimit) {
