...
import org.eqasim.switzerland.ch.utils.PTPassengerCountingActivator;
import org.eqasim.switzerland.ch.utils.PTPassengerCountingHandler;
import org.eqasim.switzerland.ch.utils.PTPassengerCountingWriter;
...
public class RunSimulation_PTcounts {
	static public void main(String[] args) throws ConfigurationException {
        ...
        PTPassengerCountingHandler ptHandler = PTPassengerCountingHandler.fromTransitSchedule(scenario.getTransitSchedule());
        controller.getEvents().addHandler(ptHandler);

        // Register CSV writer to run at end of simulation
        String outputPath = "pt_passenger_counts.csv.gz";
        controller.addControlerListener(new PTPassengerCountingActivator(ptHandler));
        controller.addControlerListener(new PTPassengerCountingWriter(ptHandler, outputPath));
