...
public class PlanRouter {
	public final ActivityFacilities facilities;
	public final TripRouter tripRouter;
	public final StageActivityTypes stageActivityTypes;
	public final MainModeIdentifier mainModeIdentifier;
	...
	public void run(Plan plan, String mainMode, boolean replaceExistingRoutes) {
		List<Trip> trips = TripStructureUtils.getTrips(plan, stageActivityTypes);
