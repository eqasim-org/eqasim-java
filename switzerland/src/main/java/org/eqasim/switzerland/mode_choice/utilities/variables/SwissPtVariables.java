...
public class SwissPtVariables implements BaseVariables {
    ...
    public SwissPtVariables (double inVehicleTime_min, double waitingTime_min, double accessEgressTime_min,
                             int numberOfLineSwitches, double cost_MU, double euclideanDistance_km, double routedInVehicleDistance_km){
