...
public class RunSimulation {
	static public void main(String[] args) throws ConfigurationException {
		...
		eqasimConfig.setEstimator("walk", "qcWalkEstimator");
		eqasimConfig.setEstimator("pt", "qcPTEstimator");
		eqasimConfig.setEstimator("car", "qcCarEstimator");
		eqasimConfig.setEstimator("car_passenger", "qcCarPassengerEstimator");


		Controler controller = new Controler(scenario);
		EqasimConfigurator.configureController(controller);
		controller.addOverridingModule(new EqasimModeChoiceModule());
		controller.addOverridingModule(new QuebecModeChoiceModule(cmd));
