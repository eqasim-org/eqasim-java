...
public class PtPredictor {
	...
	public PtVariables predict(PersonVariables personVariables, DiscreteModeChoiceTrip trip,
		...
		double cost_BRL = costModel.calculate_BRL(personVariables, crowflyDistance_km);

		return new PtVariables(inVehicleTime_min, waitingTime_min, accessEgressTime_min, numberOfLineSwitches, cost_BRL,
				crowflyDistance_km);
	}
}
