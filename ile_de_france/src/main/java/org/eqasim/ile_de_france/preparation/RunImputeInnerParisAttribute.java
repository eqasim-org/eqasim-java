package org.eqasim.ile_de_france.preparation;
...
public class RunImputeInnerParisAttribute {
	public static void main(String[] args)
		...
		// Load IRIS
		Map<String, IRIS> iris = IRIS.read(new File(cmd.getOptionStrict("iris-path")));
		...
		// Impute attribute
		ImputeInnerParisAttribute imputeInnerParisAttribute = new ImputeInnerParisAttribute(iris);
		imputeInnerParisAttribute.run(scenario.getPopulation());
