...
public class IDFMotorbikeVariables implements BaseVariables {
	...
	public IDFMotorbikeVariables(double travelTime_min, double cost_MU, double euclideanDistance_km,
