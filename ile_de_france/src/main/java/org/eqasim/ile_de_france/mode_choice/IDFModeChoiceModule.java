...
import org.eqasim.ile_de_france.mode_choice.costs.DrtCostModel;
...
public class IDFModeChoiceModule extends AbstractEqasimExtension {
	...
	public static final String DRT_COST_MODEL = "IDFDrtCostModel";
	...
	protected void installEqasimExtension() {
		...
		bindCostModel(DRT_COST_MODEL).to(DrtCostModel.class);
