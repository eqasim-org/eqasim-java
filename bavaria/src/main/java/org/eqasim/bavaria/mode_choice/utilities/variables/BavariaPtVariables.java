...
public class BavariaPtVariables implements BaseVariables {
	...
	public BavariaPtVariables(double inVehicleTime_min, double waitingTime_min, double accessEgressTime_min,
