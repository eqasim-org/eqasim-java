 ...
 * @author cdobler
 */
public class EqasimFreeSpeedTravelTimeTrafficLights  extends EqasimFreeSpeedTravelTime {

	private final double crossingPenalty;
	
	public EqasimFreeSpeedTravelTimeTrafficLights(double crossingPenalty) {
		super(crossingPenalty);
