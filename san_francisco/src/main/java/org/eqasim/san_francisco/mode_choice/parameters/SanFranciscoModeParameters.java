...
public class SanFranciscoModeParameters extends ModeParameters {
	...
	public static SanFranciscoModeParameters buildDefault() {
		...
		parameters.sfCar.alpha_car_city = -0.3;
		...
		// PT
		parameters.pt.alpha_u = -3.7026;
		parameters.sfPT.travelTime_min = -0.0100;
		parameters.sfPT.alpha_pt_city = 2.378;

		// Bike
		parameters.bike.alpha_u = -1.4;
		...
		parameters.sfWalk.alpha_walk_city = 0.9149;
